...
class SpecificCoin extends React.Component<any, any> {
  ...
  handleGetCompanyHoldings = () => {
    this.props.getCompanyHoldings(this.props.specificCoinData.cryptoName);
  };

  render() {
    const specificCoinData = this.props.specificCoinData;
    const companyHoldings = this.props.companyHoldings;
    return (
      <>
        <div id="select-box-container">
          <select onChange={this.handleSelection} id="select-element">
          ...
          <div id="data-container">
            ...
            <p id="description">
              {specificCoinData.data.description &&
                this.URLReplacer(specificCoinData.data.description.en)}
            </p>
            <div id="companies-button-container">
              <button
                id="companies-button"
                onClick={this.handleGetCompanyHoldings}
              >
